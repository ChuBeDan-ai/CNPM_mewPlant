...
function OrderManagement() {
    ...
    const handleApproveOrder = (index) => {
        ...
        updatedOrders[index].status = 'đã duyệt'; // Thay đổi trạng thái thành "đã duyệt"
    ...
    const approvedOrders = orders.filter((order) => order.status === 'đã duyệt').length;
                                ...
                                {orders.map((order, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            {order.status === 'đã duyệt' && <span>{order.status}</span>} {/* Hiển thị trạng thái đã duyệt */}
                                        </td>
