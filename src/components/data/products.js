const products = [
    ...
    {
        id: 10,
        name: 'Cây sen sao biển',
        image: '/images/caysensaobien.webp',
        price: '100,000 đ',
        description:
            'Giới thiệu cây Sen Sao Biển Trân ChâuTên khác: Móng Rồng Sao Biển, Sen Đá Móng Rồng ViềnHọ thực vật: CrassualaceaeĐặc điểmLá cây mọng nước, thuôn hình mũi mác, nhọn ở đầu, viền lá có gai.',
    },
    {
        id: 11,
    ...
    },
    {
        id: 16,
        name: 'Cây Thanh Tâm',
        image: '/images/caythanhtam.webp',
        price: '200,000 đ',
        description:
            'Cây Thanh Tâm tên khoa học: Aglaonema modestum SchottHọ: AglaonemaNguồn gốc xuất xứ: vùng phía Bắc Bangladesh, miền Nam Trung Quốc.',
    },
    {
        id: 17,
        name: 'Cây Bạch Mã',
        image: '/images/caybachma.webp',
        price: '110,000 đ',
        description:
            'Giới thiệu Cây Bạch Mã Hoàng Tử Tên gọi khác: cây Bạch Mã Tên khoa học: Aglaonema PseudobracteatumHọ: AraceaeChiều cao: trung bình từ 40-150cm',
    },
    {
        id: 18,
        name: 'Cây Huy Hoàng',
        image: '/images/cayhuyhoang.webp',
        price: '110,000 đ',
        description: 'Giới thiệu cây Huy hoàng Tên thường gọi: Huy hoàng Tên khoa học: Aglaonema spHọ: Araceae (Ráy)',
    },
    {
        id: 19,
    ...
    {
        id: 20,
        name: 'Cây sen đá xanh',
        image: '/images/sendaxanh.webp',
        price: '190,000 đ',
        description:
            'Sen Đá Xanh thường cao từ 10-20cm, lá mọng nước và xếp vòng xoắn quanh thân như bông hoa sen, lá có màu xanh ngọc, hơi xám của phấn phủ trên lá.',
    },
    {
        id: 16,
        name: 'Cây Ngân Bính',
